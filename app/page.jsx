    ...
    return (
        <main className="">
            ...
            <section className=" max-w-screen-lg mx-auto w-full my-20 sm:my-20 md:my-24 lg:my-28 ">
                <h2 className=" text-center text-2xl sm:text-2xl md:text-3xl lg:text-3xl font-Poppins font-light px-6 sm:px-6 md:px-8 lg:px-8 py-0">
                ...
                <p className=" text-gray-600  text-center text-lg sm:text-lg md:text-xl lg:text-2xl px-6 leading-normal sm:leading-normal md:leading-relaxed lg:leading-relaxed ">
            ...
            <section className=" max-w-screen-lg mx-auto w-full my-24 sm:my-24 md:my-24 lg:my-28 ">
                <div className=" grid cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-4 md:gap-0 lg:gap-0 mx-6 sm:mx-6 md:mx-3 lg:mx-0">
                    <div className="rounded-se-full rounded-es-full overflow-hidden bg-cover bg-center" style={{ backgroundImage: `url(${bannerexperiencia.src})` }}>
            ...
            <section className=" max-w-screen-lg mx-auto w-full my-24 sm:my-24 md:my-24 lg:my-28 ">
                <h2 className=" w-full mx-auto mb-6 text-3xl uppercase font-extrabold text-center">Campañas</h2>
                <p className=" w-full mx-auto font-bold text-center text-lg sm:text-lg md:text-xl lg:text-2xl px-6 leading-normal sm:leading-normal md:leading-relaxed lg:leading-relaxed">¿Quiere saber de nuestras campañas y propuestas para usted?</p>
            ...
            <section className="w-full shadow-inner shadow-black " style={{ backgroundImage: `url(${contactofondo.src})` }}>
                <div className=" bg-black bg-opacity-30 w-full py-12 px-4">
                    ...
                    <form className="py-8 mx-auto w-full max-w-3xl bg-white rounded-xl p-4  shadow-lg shadow-black" method="post" >
                        ...
                        <p className="mt-8">
                            <label className=" block text-base" for="asunto">Asunto</label>
                            <input className=" block w-full border-2 border-solid border-gray-300 p-2 bg-white" type="text" id="asunto" name="asunto" />
                        </p>
                        <p className="mt-8">
                            <label className=" block text-base" for="mensaje">Mensaje</label>
