        ...
        <main className="">
            <section className="mt-16 sm:mt-16 md:mt-16 lg:mt-24 bg-cover bg-center" style={{ backgroundImage: `url(${campagnasCover.src})` }}>
                <div className=" bg-black bg-opacity-30 w-full mx-auto py-48">
                    <h2 data-aos="fade-down" className=" max-w-screen-lg mx-auto text-center text-white text-opacity-100 text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-bold uppercase font-Poppins">Campañas</h2>
            ...
            <section className=" max-w-screen-lg mx-auto w-full my-20 sm:my-20 md:my-24 lg:my-28 ">
                <h2 data-aos="fade-down" className=" text-center text-xl sm:text-xl md:text-2xl lg:text-2xl font-Poppins font-bold px-6 sm:px-6 md:px-8 lg:px-8 py-0">
                ...
                <p data-aos="fade-up" className="mx-auto max-w-3xl text-gray-600  text-center text-lg sm:text-lg md:text-xl lg:text-2xl px-6 leading-normal sm:leading-normal md:leading-relaxed lg:leading-relaxed ">
            ...
            <section className=" w-full my-20 sm:my-20 md:my-24 lg:my-28 ">
                    ...
                    <div className=" max-w-screen-lg w-full mx-auto mt-6 text-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#1E73BE] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Autos</p>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#1E73BE] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Camionetas</p>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#1E73BE] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Casa Rodante</p>
                    ...
                    <div className=" max-w-screen-lg w-full mx-auto mt-6 text-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#E68A24] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Autos</p>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#E68A24] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Taxi ejecutivo</p>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#E68A24] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Minibús escolar</p>
                    ...
                    <div className=" max-w-screen-lg w-full mx-auto mt-6 text-center grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
                        <div>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#78C93E] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Camión</p>
                            <p data-aos="slide-left" className="text-left my-4 bg-[#78C93E] p-3 text-white text-lg sm:text-lg md:text-xl lg:text-2xl">Tracto camión</p>
