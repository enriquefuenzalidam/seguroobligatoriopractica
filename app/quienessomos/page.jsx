    ...
    return (
        <main className="">
            ...
            <section className=" max-w-screen-lg mx-auto my-24 sm:my-24 md:my-24 lg:my-28 ">
                ...
                <div className=" w-11/12 sm:w-11/12 md:w-2/3 lg:w-2/3 bg-[#F68F2A] pt-20 sm:pt-20 pb-12 sm:pb-12 md:py-12 lg:py-12 mx-auto sm:mx-auto md:mx-8 lg:mx-8">
                    <div data-aos-once="true" data-aos="fade-right" className=" mx-6 sm:mx-6 md:ml-6 lg:ml-6 text-white ">
                        ...
                        <p className=" text-lg sm:text-lg md:text-lg lg:text-xl leading-normal ">Fuente: HDI Seguros</p>
                    </div>
                </div>
            </section>
            <section className=" max-w-screen-lg mx-auto my-24 sm:my-24 md:my-24 lg:my-28 ">
            ...
            <section className=" max-w-screen-lg mx-auto my-24 sm:my-24 md:my-24 lg:my-28 ">
                ...
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">El SOAP otorga cobertura en caso de muerte y lesiones corporales que sean consecuencia directa de accidentes en los cuales intervenga el vehículo asegurado.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">También cubre los gastos médicos relativos a la atención pre hospitalaria y el transporte sanitario, la hospitalización, la atención médica, quirúrgica, dental, prótesis, implantes, los gastos farmacéuticos y de rehabilitación de las víctimas.</p>
                ...
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">1.— Concurrir a un Servicio de Urgencia para ser atendido por sus lesiones físicas (conductor, pasajero, peatón, ciclista, motorista), especificando que es un accidente de tránsito.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">2.— Realizar la denuncia en Carabineros de Chile. Para ello, debe conocer la patente del vehículo, ya que sin este dato no será posible identificar el vehículo involucrado.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">3.— Solicitar certificado otorgado por el Tribunal competente o el Ministerio Público, en el cual se consignen los datos del accidente de tránsito, de acuerdo al parte enviado al tribunal competente.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">4.— Denunciar el siniestro ante la compañía de seguros.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">5.— Guardar todas las boletas de los gastos médicos que haya incurrido y todos los certificados médicos que tenga a raíz del accidente. Éstos, junto con el certificado de accidente, deberán ser presentados a la aseguradora para el reembolso de los gastos médicos.</p>
                ...
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">En general, el plazo es de un año contado desde la fecha en que ocurrió el accidente o a partir de la muerte del accidentado, según sea el caso.</p>
                <p className="mx-8 mt-2 sm:mt-2 md:mt-3 lg:mt-4 font-normal text-lg sm:text-lg md:text-lg lg:text-xl text-gray-600">En caso de incapacidad permanente, el plazo es de un año desde la fecha de emisión del certificado médico, el cual no podrá presentarse luego de dos años desde la el cual no podrá presentarse luego de dos años desde la fecha del accidente.</p>
            </section>
        </main>
    );
}
